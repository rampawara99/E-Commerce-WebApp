...
import { addProduct, deleteItem, productList, categoryApi, updateProudct, currentSellerProducts, limitedProduct } from '../controllers/products.js';
...
Router.get('/category-limited/:key', limitedProduct);
